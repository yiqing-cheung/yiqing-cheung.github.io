---
layout: research-dashboard
title: Research
permalink: /research/
---

<div class="research-dashboard" data-research-dashboard>
  <aside class="research-sidebar" aria-label="研究报告目录">
    <div class="research-sidebar-head">
      <span>目录</span>
      <button class="research-close" type="button" data-menu-toggle aria-label="关闭目录" aria-expanded="false">×</button>
    </div>
    <div class="research-section-label">RESEARCH</div>
    <nav class="research-tree">
      <section class="tree-section">
        ...
        <div id="pgm-tree" class="tree-branch">
          <a id="pgm-china-inventory" class="tree-link level-2" href="/research/reports/index.html" data-report="/research/reports/index.html" data-title="1.1 铂钯广期所库存">1.1 铂钯广期所库存</a>
          <a id="pgm-overseas-inventory" class="tree-link level-2" href="/research/reports/nymex.html" data-report="/research/reports/nymex.html" data-title="1.2 铂钯海外库存">1.2 铂钯海外库存</a>
          ...
          <div id="china-trade-tree" class="tree-branch nested">
            ...
            <a id="china-palladium-balance" class="tree-link level-3" href="/research/reports/pd_balance.html" data-report="/research/reports/pd_balance.html" data-title="1.3.4 中国钯供需平衡表">1.3.4 中国钯供需平衡表</a>
          </div>
      ...
      <section class="tree-section">
        <button class="tree-toggle level-1" type="button" data-tree-toggle aria-expanded="true" aria-controls="silver-tree"><span class="tree-caret" aria-hidden="true"></span><span>2. AG 白银</span></button>
        <div id="silver-tree" class="tree-branch">
          <button class="tree-toggle level-2" type="button" data-tree-toggle aria-expanded="true" aria-controls="silver-spread-tree"><span class="tree-caret" aria-hidden="true"></span><span>2.1 价差分析</span></button>
          <div id="silver-spread-tree" class="tree-branch nested">
            <a id="comex-silver-spread" class="tree-link level-3" href="/research/reports/comex_silver.html" data-report="/research/reports/comex_silver.html" data-title="2.1.1 COMEX 白银月差">2.1.1 COMEX 白银月差</a>
          </div>
        </div>
      </section>
    </nav>
  ...
  <main class="research-content">
    <header class="research-toolbar">
      ...
      <a class="research-open-link" href="/research/reports/index.html" target="_blank" rel="noopener" data-open-report>新窗口打开 ↗</a>
    </header>
    <div class="research-frame-wrap">
      <iframe class="research-frame" src="/research/reports/index.html" title="1.1 铂钯广期所库存" data-report-frame></iframe>
    </div>
  </main>
</div>
